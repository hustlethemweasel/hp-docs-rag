...
| R7 | Chunking strategy | Heading/structure-aware recursive chunking with overlap (§7.2) | In progress — chunker, parsing, embedder, figure extraction + captioning all implemented and unit-tested; pgvector writes pending |
